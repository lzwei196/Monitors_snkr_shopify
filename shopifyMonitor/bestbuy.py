                    ...
                    try:
                        ...
                        if shipping_status != shipping or instore_status!=instore:
                            ...
                            if instore_status == True:
                                link = best_buy_base_url+id
                                notifyDisc_bestbuy(name, link,"instore", True)
                            update = best_buy.query.filter_by(id_number=id).first()
