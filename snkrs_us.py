from shopifyWebhook import notifyDisc_snkrs_us, notifyDisc_snkrs_non_product_us,notifyDisc_nike_us
...
def call_discord(base_url, data):
    ...
    if "productInfo" in data:
        ...
        if "launchView" in info:
                ...
                notifyDisc_snkrs_us(image_url, link, title, price, active, style_code, exclusiveAccess, availability, method,
                                 date)
        else:
            notifyDisc_snkrs_us(image_url, link, title, price, active, style_code, exclusiveAccess, availability)
    else:
        ...
        notifyDisc_snkrs_non_product_us(image_url, link, title, date, description)
...
def call_discord_nike(base_url, data):
    ...
    notifyDisc_nike_us(image_url,link, title, price, status, styleColor, availability, date)
...
def monitor_snkrs(base_url, api_url):
        while True:
            ...
            try:
                ...
                nike = Nike(current_status, 'snkrs_us')
...
def monitor_nike(base_url, api_url):
    while True:
        ...
        try:
            ...
            nike = Nike(current_status, 'nike_us')
...
if(__name__ == "__main__"):
    api_snkr_us = "https://api.nike.com/product_feed/threads/v2/?anchor=0&count=21&filter=marketplace%28US%29&filter=language%28en%29&filter=channelId%28010794e5-35fe-4e32-aaff-cd2c74f89d61%29&filter=exclusiveAccess%28true%2Cfalse%29"
    api_nike_us = "https://api.nike.com/cic/browse/v1?queryid=filteredProductsWithContext&anonymousId=V7KpaHChtIdYMZ4P4eDSi&uuids=0f64ecc7-d624-4e91-b171-b83a03dd8550,16633190-45e5-4830-a068-232ac7aea82c&language=en&country=US&channel=NIKE&sortBy=newest"
    nike_us_base_url = "https://www.nike.com/t/"
    snkrs_us_base_url = "https://www.nike.com/launch/"
    try:
